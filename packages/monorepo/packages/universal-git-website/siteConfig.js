const users = [
  {
    caption: 'Awesome OS',
    image: '/img/logo.svg',
    infoLink: 'https://awesome-os.com',
    pinned: true
  }
]

const siteConfig = {
  title: 'universal-git' /* title for your website */,
  tagline: 'A pure JavaScript implementation of git for node and browsers!',
  url: 'https://awesome-os.com/universal-git' /* your website url */,
  cname: 'awesome-os.com' /* gets overwritten each time */,
  baseUrl: '/' /* base url for your project */,
  editUrl: 'https://github.com/awesome-os/universal-git/edit/main/docs/',
  headerLinks: [
    {
      doc: 'alphabetic',
      label: 'API Docs'
    ...
    {
      href: 'https://github.com/awesome-os/universal-git',
      label: 'GitHub'
    },
    {
  ...
  repoUrl: 'https://github.com/awesome-os/universal-git',
  algolia: {
