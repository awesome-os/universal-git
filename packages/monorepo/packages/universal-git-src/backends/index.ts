throw new Error('@deprecated should use the respective backend directory instead')
// export type { GitBackend } from './GitBackend.ts'
// export { GitBackendFs } from './GitBackendFs/index.ts'
...
//       const opt = opts as GitBackendFsOptions
//       if (!opt.fs || !opt.gitdir) {
//         throw new Error('GitBackendFs requires fs and gitdir options')
//       }
...
//       return new GitBackendFs(normalizedFs, opt.gitdir)
//     })
//   }
