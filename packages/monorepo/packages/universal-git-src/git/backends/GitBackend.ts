...
import type { UniversalBuffer } from './GitBackendFs/utils/UniversalBuffer.ts'
...
export type GitBackend = {
   ...
   */
  writeConfig(data: string): Promise<void>
  ...
  runHook(
    hookName: string,
    context?: import('../hooks/runHook.ts').HookContext,
    executor?: import('../hooks/runHook.ts').HookExecutor,
    stdin?: string | UniversalBuffer,
    args?: string[]
  ): Promise<import('../hooks/runHook.ts').HookResult>
   ...
   */
  readGitmodules(worktreeBackend: import('../worktree/GitWorktreeBackend.ts').GitWorktreeBackend): Promise<string | null>
   ...
   */
  writeGitmodules(worktreeBackend: import('../worktree/GitWorktreeBackend.ts').GitWorktreeBackend, data: string): Promise<void>
   ...
   */
  parseGitmodules(worktreeBackend: import('../worktree/GitWorktreeBackend.ts').GitWorktreeBackend): Promise<Map<string, { path: string; url: string; branch?: string }>>
   ...
   */
  getSubmoduleByName(worktreeBackend: import('../worktree/GitWorktreeBackend.ts').GitWorktreeBackend, name: string): Promise<{ name: string; path: string; url: string; branch?: string } | null>
   ...
   * @returns Submodule info with name, or null if not found
   */
  getSubmoduleByPath(worktreeBackend: import('../worktree/GitWorktreeBackend.ts').GitWorktreeBackend, path: string): Promise<{ name: string; path: string; url: string; branch?: string } | null>
   ...
   * @param name - Submodule name
   */
  initSubmodule(worktreeBackend: import('../worktree/GitWorktreeBackend.ts').GitWorktreeBackend, name: string): Promise<void>
   ...
   */
  isSubmodule(worktreeBackend: import('../worktree/GitWorktreeBackend.ts').GitWorktreeBackend, path: string): Promise<boolean>
  ...
  status(
    worktreeBackend: import('../worktree/GitWorktreeBackend.ts').GitWorktreeBackend,
    filepath: string
  ): Promise<import('./GitBackendFs/commands/status.ts').FileStatus>
  ...
  ): Promise<import('./GitBackendFs/commands/statusMatrix.ts').StatusRow[]>
  ...
  ): Promise<import('./GitBackendFs/commands/diff.ts').DiffResult>
  ...
  getRemoteInfo(
    url: string,
    options?: {
      http?: import('../remote/types.ts').HttpClient
      ...
      onAuth?: import('../remote/types.ts').AuthCallback
      onAuthSuccess?: import('../remote/types.ts').AuthSuccessCallback
      onAuthFailure?: import('../remote/types.ts').AuthFailureCallback
      onProgress?: import('../remote/types.ts').ProgressCallback | import('../ssh/SshClient.ts').SshProgressCallback | import('../daemon/TcpClient.ts').TcpProgressCallback
      corsProxy?: string
      headers?: Record<string, string>
      forPush?: boolean
      protocolVersion?: 1 | 2
    }
  ): Promise<import('./GitBackendFs/commands/getRemoteInfo.ts').GetRemoteInfoResult>
  ...
  ): Promise<import('../refs/types.ts').ServerRef[]>
