...
import { writeBundle } from '../../../bundle/writeBundle.ts'
import { parseBundle, parseBundleHeader } from '../../../bundle/parseBundle.ts'
import { readObject } from '../../../objects/readObject.ts'
import { readRef } from '../../../refs/readRef.ts'
...
export async function verifyBundle({
  ...
  try {
    ...
    // Extract packfile
    const { extractPackfileFromBundle } = await import('../../../bundle/parseBundle.ts')
