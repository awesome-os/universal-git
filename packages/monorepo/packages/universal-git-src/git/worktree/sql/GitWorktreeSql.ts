...
/**
 * GitWorktreeSql - SQL database implementation of GitWorktreeBackend
 * 
 * This backend stores all working directory files in a SQL database.
 * 
 * **Submodule Awareness**:
 * 
 ...
 */
export class GitWorktreeSql implements GitWorktreeBackend {
  readonly name: string
  private readonly database: any // SQL database interface (to be defined)
  ...
  getFileSystem(): null {
    return null // SQL backend doesn't use filesystem
  }

  getDirectory(): null {
    return null // SQL backend doesn't have a directory path
  }
  ...
  // ============================================================================
  // File Operations - Stub implementations (delegate to submodules)
  // ============================================================================
  ...
  async read(
    ...
    throw new Error('SQL backend read not yet implemented')
  }
  ...
  async write(
    ...
    throw new Error('SQL backend write not yet implemented')
  }
  ...
  async exists(path: string, options?: Record<string, unknown>): Promise<boolean> {
    ...
    throw new Error('SQL backend exists not yet implemented')
  }

  // Stub implementations for other required methods (all delegate to submodules first)
  async mkdir(path: string, options?: { recursive?: boolean }): Promise<void> {
    const submodule = await this.resolvePath(path)
    if (submodule.worktree !== this) {
      return submodule.worktree.mkdir(submodule.relativePath, options)
    }
    throw new Error('SQL backend mkdir not yet implemented')
  }
  ...
  async readdir(path: string): Promise<string[] | null> {
    ...
    throw new Error('SQL backend readdir not yet implemented')
  }
  ...
  async readdirDeep(path: string): Promise<string[]> {
    ...
    throw new Error('SQL backend readdirDeep not yet implemented')
  }
  ...
  async rmdir(path: string, options?: { recursive?: boolean }): Promise<void> {
    ...
    throw new Error('SQL backend rmdir not yet implemented')
  }
  ...
  async rm(path: string, options?: { recursive?: boolean }): Promise<void> {
    ...
    throw new Error('SQL backend rm not yet implemented')
  }
  ...
  async stat(path: string): Promise<import('../../../utils/statHelpers.ts').ExtendedStat | null> {
    ...
    throw new Error('SQL backend stat not yet implemented')
  }
  ...
  async lstat(path: string): Promise<import('../../../utils/statHelpers.ts').ExtendedStat | null> {
    ...
    throw new Error('SQL backend lstat not yet implemented')
  }
  ...
  async readlink(
    ...
    throw new Error('SQL backend readlink not yet implemented')
  }
  ...
  async writelink(path: string, target: string): Promise<void> {
    ...
    throw new Error('SQL backend writelink not yet implemented')
  }

  async readWorktreeConfig(gitdir: string): Promise<import('../../../core-utils/ConfigParser.ts').ConfigObject | null> {
    throw new Error('SQL backend readWorktreeConfig not yet implemented')
  }
  ...
  async writeWorktreeConfig(
    ...
    throw new Error('SQL backend writeWorktreeConfig not yet implemented')
  }

  async sparseCheckoutInit(gitdir: string, cone?: boolean): Promise<void> {
    throw new Error('SQL backend sparseCheckoutInit not yet implemented')
  }
  ...
  async sparseCheckoutSet(
    ...
    throw new Error('SQL backend sparseCheckoutSet not yet implemented')
  }

  async sparseCheckoutList(gitdir: string): Promise<string[]> {
    throw new Error('SQL backend sparseCheckoutList not yet implemented')
  }
  ...
  async add(
    ...
    throw new Error('SQL backend add not yet implemented')
  }
  ...
  async remove(
    ...
    throw new Error('SQL backend remove not yet implemented')
  }
  ...
  async commit(
    ...
    throw new Error('SQL backend commit not yet implemented')
  }
  ...
  async checkout(
    ...
    throw new Error('SQL backend checkout not yet implemented')
  }
  ...
  async switch(
    ...
    throw new Error('SQL backend switch not yet implemented')
  }
  ...
  async status(
    ...
    throw new Error('SQL backend status not yet implemented')
  }
  ...
  async statusMatrix(
    ...
    throw new Error('SQL backend statusMatrix not yet implemented')
  }
  ...
  async reset(
    ...
    throw new Error('SQL backend reset not yet implemented')
  }
  ...
  async diff(
    ...
    throw new Error('SQL backend diff not yet implemented')
  }
  ...
  async mergeTree(
    ...
    throw new Error('SQL backend mergeTree not yet implemented')
  }
}
