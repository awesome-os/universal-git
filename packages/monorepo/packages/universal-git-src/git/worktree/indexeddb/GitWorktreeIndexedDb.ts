...
/**
 * GitWorktreeIndexedDb - IndexedDB implementation of GitWorktreeBackend
 * 
 * This backend stores all working directory files in browser IndexedDB.
 ...
 */
export class GitWorktreeIndexedDb implements GitWorktreeBackend {
  ...
  getFileSystem(): null {
    return null // IndexedDB backend doesn't use filesystem
  }

  getDirectory(): null {
    return null // IndexedDB backend doesn't have a directory path
  }
  ...
  async read(
    ...
    throw new Error('IndexedDB backend read not yet implemented')
  }
  ...
  async write(
    ...
    throw new Error('IndexedDB backend write not yet implemented')
  }
  ...
  async exists(path: string, options?: Record<string, unknown>): Promise<boolean> {
    ...
    throw new Error('IndexedDB backend exists not yet implemented')
  }
  ...
  async mkdir(path: string, options?: { recursive?: boolean }): Promise<void> {
    ...
    throw new Error('IndexedDB backend mkdir not yet implemented')
  }
  ...
  async readdir(path: string): Promise<string[] | null> {
    ...
    throw new Error('IndexedDB backend readdir not yet implemented')
  }
  ...
  async readdirDeep(path: string): Promise<string[]> {
    ...
    throw new Error('IndexedDB backend readdirDeep not yet implemented')
  }
  ...
  async rmdir(path: string, options?: { recursive?: boolean }): Promise<void> {
    ...
    throw new Error('IndexedDB backend rmdir not yet implemented')
  }
  ...
  async lstat(path: string): Promise<import('../../../utils/statHelpers.ts').ExtendedStat | null> {
    ...
    throw new Error('IndexedDB backend lstat not yet implemented')
  }
  ...
  async readlink(
    ...
    throw new Error('IndexedDB backend readlink not yet implemented')
  }
  ...
  async writelink(path: string, target: string): Promise<void> {
    ...
    throw new Error('IndexedDB backend writelink not yet implemented')
  }

  async readWorktreeConfig(gitdir: string): Promise<import('../../../core-utils/ConfigParser.ts').ConfigObject | null> {
    throw new Error('IndexedDB backend readWorktreeConfig not yet implemented')
  }
  ...
  async writeWorktreeConfig(
    ...
    throw new Error('IndexedDB backend writeWorktreeConfig not yet implemented')
  }

  async sparseCheckoutInit(gitdir: string, cone?: boolean): Promise<void> {
    throw new Error('IndexedDB backend sparseCheckoutInit not yet implemented')
  }
  ...
  async sparseCheckoutSet(
    ...
    throw new Error('IndexedDB backend sparseCheckoutSet not yet implemented')
  }

  async sparseCheckoutList(gitdir: string): Promise<string[]> {
    throw new Error('IndexedDB backend sparseCheckoutList not yet implemented')
  }
  ...
  async add(
    ...
    throw new Error('IndexedDB backend add not yet implemented')
  }
  ...
  async remove(
    ...
    throw new Error('IndexedDB backend remove not yet implemented')
  }
  ...
  async commit(
    ...
    throw new Error('IndexedDB backend commit not yet implemented')
  }
  ...
  async checkout(
    ...
    throw new Error('IndexedDB backend checkout not yet implemented')
  }
  ...
  async switch(
    ...
    throw new Error('IndexedDB backend switch not yet implemented')
  }
  ...
  async reset(
    ...
    throw new Error('IndexedDB backend reset not yet implemented')
  }
  ...
  async mergeTree(
    ...
    throw new Error('IndexedDB backend mergeTree not yet implemented')
  }
}
