...
While `universal-git` tries not to block the main thread, it still does on occasion.
This can cause your webapp to stutter or even freeze up briefly!
To achieve buttery smooth performance, you'll eventually want to move all your `universal-git` usage off of the main thread.
...
<iframe
  src="https://codesandbox.io/embed/magic-portal-with-universal-git-ejdoo?fontsize=14&hidenavigation=1&module=%2Fworker.js&theme=dark"
  style="width:100%; height:500px; border:0; border-radius: 4px; overflow:hidden;"
  title="universal-git@1.0 in a Worker example"
