...
You need to pass an HTTP client into `universal-git` functions that make HTTP requests.
Both a node client (`universal-git/http/node`) and a browser client (`universal-git/http/web`) are included in the npm package, but you have to pick which one to use.
...
git.getRemoteInfo({ http, url: 'https://github.com/universal-git/universal-git' })
  .then(console.log)
```
...
```html
<script src="https://unpkg.com/universal-git/http/web/index.umd.js">
<script>
git.getRemoteInfo({ http: GitHttp, url: 'https://github.com/universal-git/universal-git' })
  .then(console.log)
```
...
To get started, you might want to look at [`src/http/node/index.js`](https://github.com/universal-git/universal-git/blob/main/src/http/node/index.js)
and [`src/http/web/index.js`](https://github.com/universal-git/universal-git/blob/main/src/http/web/index.js).
