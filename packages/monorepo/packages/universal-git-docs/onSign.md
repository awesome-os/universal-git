...
```js
import { pgp } from '@universal-git/pgp-plugin'
git.commit({ ..., onSign: pgp.sign })
```

You can choose between an [OpenPGP.js implementation](https://github.com/universal-git/openpgp-plugin) and an [isomorphic-pgp implementation](https://github.com/universal-git/pgp-plugin)!
...
import { pgp } from '@universal-git/pgp-plugin'
import { resolveRef, readCommit } from 'universal-git'
