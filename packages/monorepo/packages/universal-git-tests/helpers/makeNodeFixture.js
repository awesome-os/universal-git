...
var testsDir = (0, path_1.resolve)(import.meta.dirname, '..');
var projectRoot = (0, path_1.resolve)(testsDir, '..');
function useTempDir(fixture) {
    return __awaiter(this, void 0, void 0, function () {
        var fixturePath, tempDir;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, find_up_1.default)((0, path_1.join)('__fixtures__', fixture), {
                        cwd: (0, path_1.join)(projectRoot, 'tests'),
                        type: 'directory',
                    })];
                case 1:
                    fixturePath = _a.sent();
