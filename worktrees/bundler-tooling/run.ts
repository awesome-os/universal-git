...
import { createChunks, createDependencyGraph, createEntryChunks, createReverseDependencyGraph, createVirtualBarrelFile, groupChunkByDirectory } from './dependencies/createDependencyGraph.js';
import * as path from 'path';
import { normalizePath } from './dependencies/pathUtils.js';
import { entryPoints, project } from './tsconfig.js';
export { project };
