...
import { analyzeProjectSymbols } from '../dependencies/symbolAnalyzer.js';
import { generateInterfaceFiles } from '../dependencies/interfaceGenerator.js';
import { relative } from '../dependencies/pathUtils.js'; // Using our pure 'relative' for output display
import { project} from '../tsconfig.js'
import { projectRoot } from '../tsconfig.js';
async function main() {
