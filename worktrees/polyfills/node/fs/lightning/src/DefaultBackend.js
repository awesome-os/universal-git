import require$$0 from 'isomorphic-textencoder';
import require$$1 from 'just-debounce-it';
import { __require as requireCacheFS } from './CacheFS.js';
import { __require as requireErrors } from './errors.js';
import { __require as requireIdbBackend } from './IdbBackend.js';
import { __require as requireHttpBackend } from './HttpBackend.js';
import { __require as requireMutex } from './Mutex.js';
import { __require as requireMutex2 } from './Mutex2.js';
import path__default from './path.js';
...
function requireDefaultBackend () {
	...
	const { encode, decode } = require$$0;
	const debounce = require$$1;
...
export { requireDefaultBackend as __require };
